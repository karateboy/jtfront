...
<script>
import AppTopBar from "@/prime/pages/AppTopbar.vue";
import AppProfile from "@/prime/pages/AppProfile.vue";
import AppMenu from "@/prime/pages/AppMenu.vue";
import AppFooter from "@/prime/pages/AppFooter.vue";
